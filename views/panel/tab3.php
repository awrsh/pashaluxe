    ...
    function getFavorit(folderId, tag) {
        ...
        $.post(url, data, function (msg) {
            ...
            $.each(msg, function (index, val) {
                ...
                var item = '<div class="item"><div class="right"><img src="public/images/products/' + val['idproduct'] + '/product_220.jpg ">' +
                    '</div><div class="left"><h4>' + val['productTitle'] + '' +
                    '<img class="delete" onclick="deleteFavorit(' + val['id'] + ',this)"' +
                    ' src="public/images/Delete.gif"></h4></div></div>';
