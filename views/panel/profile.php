...
<div id="main">
    ...
    <form method="post" action="panel/editprofile">
        ...
        <span class="title">
            ...
            <input class="tests" style="text-align: left" readonly type="text" name="email" value="<?= $profile['email'] ?>">
...
سال:
            ...
            <select name="year">
                ...
                <?php
                for ($i = 1340; $i <= Model::jaliliDate('Y'); $i++) {
                    ?>
...
محل سکونت:
        ...
        <span class="title">
شماره کارت:(بابت مرجوع کالا)
        </span>

            <input type="tel" class="cart_number" name="cart_number" style="width: 350px;text-align: center;font-size: 21px" value="<?= $profile['cart_number'] ?>">
...
نام بانک:
            ...
            <input type="text" name="bank_name" style="width: 350px;" value="<?= $profile['bank_name'] ?>">
...
<script>
    $('.cart_number').mask('0000,0000,0000,0000', {reverse: false});
</script>
