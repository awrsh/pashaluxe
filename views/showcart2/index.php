...
ورود به پاشالوکس</span></li>
            <li class="active"><span class="circle"></span><span class="line"></span><span class="title">اطلاعات ارسال سفارش
            </span></li>
...
اطلاعات پرداخت
    ...
    <style>
        ...
        @keyframes pulse2 {
            50% {box-shadow: #e90d53 0 0 0 0;}
            0% {box-shadow: #ff280000 0 0 0 10px}

        }
.span_add_address{
    background: url(public/images/slices.png) no-repeat -610px -269px;
    ...
    <div class="head">
        <h4>
            <span class="span_add_address"></span>
            انتخاب آدرس:
        </h4>
...
افزودن آدرس جدید
    ...
    <div class="content">
        ...
        if ($address == null) {
            echo "<p class='p_empty_address'>از قسمت افزودن آدرس جدید لطفا یک آدرس اضافه کنید</p>";
        }
        $first = 1;
        foreach ($address as $row) {
            ...
            <table data-id="<?= $row['id']; ?>" data-city="<?= $row['city']; ?>"
                ...
                <tr>
                    ...
                    <td id="map" rowspan="2" style="font-size: 10.5pt;color: #858889;z-index: 6">
    ...
    <div class="send_types">
        ...
        foreach ($postType as $row) {
            ...
            <table data-post-type="<?= $row['id'] ?>" class="table_post <?php if ($first == 1) {
                echo 'active';
            } ?> " cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style="margin: 1px 0;font-size: 12pt;color: green;text-align: center;">
                            <span id="post_price<?= $row['id']; ?>">رایگان</span>
                        </p>
                    </td>
                </tr>
            </table>
...
<script>
    ...
    var myMap = new L.Map('map', {
            key: 'web.65f8587a33c5430191e470b4c081c71c',
            maptype: 'osm-bright',
            poi: true,
            traffic: true,
