...
<div id="product_gallery">
    ...
    <div onclick="this.requestFullscreen()" class="right">

        <canvas id="cv" width="420" height="320" style="margin: auto;right:133px;position:relative;"></canvas>

        <img class="mainimage" src="" alt="<?= $productInfo['title']; ?>">
    ...
    <div class="left">
        <ul>
            ...
            if ($gallery == array())
            {
                echo "متاسفانه این محصول گالری تصاویر ندارد";
            }
