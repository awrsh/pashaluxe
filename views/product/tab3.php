...
<div id="comment_send">
    ...
    <p style="font-size: 11pt;">
        اگر این محصول را قبلا از
        پاشالوکس خریده باشید، نظر شما به عنوان مالک محصول ثبت خواهد شد.
    </p>

    <div class="email" style="text-align: left;">

        <a href="addcomment/index/<?= $data[3] ?>" class="btn btn_green">
            ارسال نظر
        </a>
...
نام نظر دهنده:
            ...
            <?= $row['tarikh']; ?>
                ...
                <div class="left">
                    ...
                    <form action="addcomment/save_dislike" method="post">


                            <span class="dislike">
                                <i id="dislike">

                          <a style="color: black;width: 5px;height: 5px;" href="addcomment/save_dislike/<?= $row['id']; ?>/<?= $row['dislikecount']; ?>/<?= $row['idproduct']; ?>"
                        ...
                        <span class="like">
                                <i id="like">
                                    <a style="color: black;width: 5px;height: 5px;" href="addcomment/save_like/<?= $row['id']; ?>/<?= $row['likecount']; ?>/<?= $row['idproduct']; ?>">
