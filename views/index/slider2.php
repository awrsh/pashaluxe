        ...
        foreach ($slider2 as $row) {
            ...
            <a class="item" href="<?= URL ?>product/index/<?= $row['id']; ?>">
                <div class="slider2_content_right">
                    ...
                    <div class="price_info">
                        ...
                        <div class="price_info_new yekan">
                            <?= number_format($row['price_total']) ?>
                           تومان
                        </div>
                        <p class="yekan fontsm" style="float: right;width: 100%;margin: 5px;">
                            تخفیف بمبی: %<?= $row['discount'];?>
                        </p>

                        <p class="yekan fontsm" style="float: right;width: 100%;margin: 5px;">
                            کد محصول:PLX-<?= $row['code_product'];?>
                        </p>
                ...
                <div class="slider2_content_left">
                    ...
                    <img class="img_time_special" src="public/images/products/<?= $row['id']; ?>/product_220.jpg" alt="<?= $row['title']; ?>">
