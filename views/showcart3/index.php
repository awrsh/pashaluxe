...
اطلاعات پرداخت
    ...
    <div class="head">
        <h4>
            بازبینی سبد خرید شما در پاشالوکس
                    ...
                    <td>
                        ...
                        <div class="left">
                            ...
                            <p style="color: #5e5e55">
                                شناسه محصول:PLX-<?= $row['code_product']; ?>
                            </p>
...
<?= $row['tedad']; ?>
                    ...
                    <td>
                        ...
                        <span class="tuman">تومان تخفیف</span>
                    </td>
                    <td class="edit_td">
                        <a href="showcart">
                            <i class="edit_icon"></i>
    ...
    <div id="final_price">
        <div id="total_price">
            ...
            <span class="total_price2">
               <?php echo number_format($basketInfo[1]) ?> تومان
            </span>
        </div>
...
هزینه ارسال ،بسته بندی و بیمه:
            ...
            <mark class="mark_information">رایگان</mark>
...
جمع کل مبلغ تخفیف:
            ...
            <span class="total_price2">
                <?php echo number_format($basketInfo[2]) ?> تومان
            </span>
        </div>
...
مبلغ قابل پرداخت:
            ...
            <span class="total_price2">
                ...
                echo number_format($priceTotal); ?> تومان
            </span>
        </div>
    ...
    <table class="review_send_info" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                این سفارش از طریق پست پاشالوکس
                به صورت
                <mark class="mark_information1">رایگان</mark>
                به شما تحویل داده خواهد
                شد.
            </td>
        </tr>
