...
<div class="left">
    ...
    <form id="addPicture" action="admin_screenShots/index" enctype="multipart/form-data" method="post"
...
آدرس لینک:
    ...
    <form id="pictureList" action="admin_ScreenShots/delete" method="post">
