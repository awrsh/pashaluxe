...
<div class="left">
 ...
 مدیریت گالری تصاویر محصولات
    ...
    <form id="addgallery" action="adminproduct/gallery/<?= $productInfo['id'] ?>" enctype="multipart/form-data" method="post" style="margin-bottom: 20px;font-size: 10pt;float: right;width: 100%;">
        ...
        <div class="row">
            <span class="span_title" style="float: right;margin: 5px">
                انتخاب تصویر:
            </span>
        ...
        <table style="text-align: center" class="list" cellspacing="0">
            ...
            foreach ($gallery as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <img style="border-radius: 10px" height="200px" width="200px" src="public/images/products/<?= $row['idproduct'] ?>/gallery/small/<?= $row['img'] ?>">
                    </td>
