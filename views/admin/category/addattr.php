...
ویژگی:
    ...
    <form action="admincategory/addattr/<?= @$categoryInfo['id']; ?>/<?= @$attrInfo['id']; ?>/<?= @$editInfo['id']; ?>" method="post">
...
عنوان ویژگی:
            ...
            <input style="font-family: Tahoma" type="text" name="title" value="<?php if ($edit == '') {} else {echo @$editInfo['title'];} ?>">
