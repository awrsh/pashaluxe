...
class Model
{
    ...
    function doQueryForChangeStatus($sql, $values = array())
    {
    ...
    function getBasket()
    {
        ...
        $sql = "select b.tedad,b.id as basketRow,p.*,c.title as colorTitle,t.hex as colorHex,g.title as garanteeTitle
         from tbl_basket b 
         LEFT JOIN tbl_product p ON b.idproduct=p.id
         LEFT JOIN tbl_color c ON b.color=c.id
         LEFT JOIN tbl_color t ON b.color=t.id
    ...
    public static function getUserLevel()
    {
        ...
        $sql = "select * from tbl_admin_user where id=?";
...
class helper
{
    ...
    private function call($url, $params, $methodType = helper::METHOD_POST)
    {
        ...
        new FrotelResponseException('Failed to Parse Response (' . json_last_error() . ')');
    }
